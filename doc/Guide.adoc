...
* Arrays are written as multiple, space separated elements of the same type,
  ...
  evaluates to [ a b b+d b+2d b+3d ... c ] where d:=b-a. If a is not given, d is
  being computed as d:=sgn(c-b), i.e d:=1 if c>b and d:=-1 if b>c.
----------
[ "Multiple" "strings" ]
[ 10 8 ... 2 ]   % 10 8 6 4 2
[ 1 ... 5 ]      %  1 2 3 4 5
...
* Arrays inside arrays do not work
* Strings inside arrays can sometimes exceed the linelength slightly
